...
import MappeAppWeb.DB.repository.coursesRepository.CourseProvidersRepository;
...
public class CoursesInitializer {
  ...
  @Autowired
  private CourseProvidersRepository courseProvidersRepository;
  @Autowired
  private TopicRepository topicRepository;

  private final Logger logger = LoggerFactory.getLogger("create a present of courses");

  /**
   * a method to create a present of courses
   */
  //by removing te "//" in the next line you activate the initialization of the database. use only
  //when you need to reinitialize the database
  //@PostConstruct
  ...
  private void initializeProviders() {
    ...
    CourseProviders NTNU = new CourseProviders(1, "NTNU");
    CourseProviders ASF = new CourseProviders(2, "ASF");
    CourseProviders pearson = new CourseProviders(3, "Person");
    CourseProviders oracle = new CourseProviders(4, "Oracle");
    CourseProviders microsoft = new CourseProviders(5, "Microsoft");
    CourseProviders amazon = new CourseProviders(6, "Amazon");
    CourseProviders adobe = new CourseProviders(7, "Adobe");
    CourseProviders apple = new CourseProviders(8, "Apple");
    CourseProviders google = new CourseProviders(9, "Google");
    CourseProviders BI = new CourseProviders(10, "BI");
    CourseProviders UIO = new CourseProviders(11, "UIO");
    CourseProviders UIB = new CourseProviders(12, "UIB");

    courseProvidersRepository.saveAll(List.of(
  ...
  public void initializeCourses() {
    ...
    Courses realTimeProgrammingJava = new Courses(1, "Real-Time Programming in Java", "Expert",
        "June 3 rd – June 28th", 7.5, 40,
    ...
    Courses azureAdministration = new Courses(5, "Azure Administration", "Intermediate",
        ...
        "Information Technology Courses");
    Courses awsCloudPractitioner = new Courses(6, "AWS Cloud Practitioner", "Biginner",
        "September 9th – September 20th", 2, 20,
