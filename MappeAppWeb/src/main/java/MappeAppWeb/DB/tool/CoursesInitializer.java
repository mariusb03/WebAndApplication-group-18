...
public class CoursesInitializer {
  ...
  @Autowired
  private ProvidersRepository courseProvidersRepository;
  @Autowired
  ...
  public void initializeCourses() {
    ...
    Courses realTimeProgrammingJava = new Courses("Real-Time Programming in Java", "Expert",
    ...
    Courses sql = new Courses("Introduction to SQL Essentials", "Beginner",
        ...
        "Information Technology Courses");
    Courses webAppWithDotNet = new Courses("Creating Web Application with .Net", "Beginner",
        "Aug 5^th – Aug 16^th", 4, 40, ".Net Developer Fundamentals", 8156, "Embark on your journey into web development with our beginner-level online course, \"Creating Web Applications with .NET.\" Tailored for those stepping into the dynamic world of web development, this course provides a solid foundation in utilizing the versatile .NET framework to build powerful and interactive web applications. Guided by experienced instructors, you'll explore fundamental concepts such as web application architecture, user interface design, and server-side scripting using .NET technologies like ASP.NET. Throughout the course, you'll engage in hands-on projects that walk you through the entire development process, from designing responsive user interfaces to implementing server-side functionality. Gain practical skills in C# programming and discover how to leverage the robust features of .NET to bring your web applications to life. Whether you're a programming novice or transitioning from another language, this course offers a welcoming entry point into the exciting realm of web application development with .NET, setting you on a path to create dynamic and engaging online experiences.",
         "Information Technology Courses");
    Courses azureFundamentals = new Courses("Azure Fundamentals", "Beginner", "Aug 5th – Aug 30th",
        ...
        "Information Technology Courses");
    Courses azureAdministration = new Courses("Azure Administration", "Intermediate",
        ...
        "Information Technology Courses");
    Courses awsCloudPractitioner = new Courses("AWS Cloud Practitioner", "Biginner",
    ...
    Courses socialMediaMarketing = new Courses("Social Media Marketing", "Intermediate",
    ...
    Courses mlBasicsPython = new Courses("Machine Learning Basics with Python", "Beginner",
    ...
    Courses imageRecognition = new Courses("Image Recognition", "Intermediate",
        ...
        "Data Science and Analytics Course");
    Courses databricksFundamentals = new Courses("Databricks Fundamentals", "Beginner",
