...
public class CoursesInitializer implements ApplicationListener<ApplicationReadyEvent> {
  ...
  private void initializeProviders() {
    ...
    providersRepository.saveAll(List.of(ntnu, asf, pearson, oracle, microsoft, amazon, adobe,
        apple, google, bi, uio, uib));
  ...
  private void initializeTopics() {
    ...
    topicRepository.saveAll(List.of(java, realTimeProgramming, multiThreading, sql,
        relationalDatabases, mySql, web, dotNet, csharp, azure, cloudServices, administration,
        aws, keywordResearch, technicalSeo, offPageSeo, advancedAnalytics, strategicStorytelling,
        targetedEngagement, dataDrivenOptimization, imageProcessing, python, machineLearning,
        programming, dataScience, neuralNetworks, databricks));
  ...
  public void initializeCourses() {
    ...
    Courses webAppWithDotNet = new Courses("Creating Web Application with .Net",
        ...
        "Embark on your journey into web development with our beginner-level online "
            ...
            + "experiences.", "Information Technology Courses");
    ...
    Courses azureAdministration = new Courses("Azure Administration", "Intermediate",
        ...
        "Elevate your cloud expertise with our intermediate-level online course,"
            ...
            + "towards advanced Azure proficiency.", "Information Technology Courses");
    Courses awsCloudPractitioner = new Courses("AWS Cloud Practitioner", "Beginner",
    ...
    Courses seo = new Courses("Search Engine Optimization", "Intermediate",
        ...
        "Deepen your expertise in the digital landscape with our intermediate-level "
            ...
            + " our intermediate-level SEO course", "Digital Marketing Courses");
    ...
    Courses businessStrategy = new Courses("Business Strategy", "Beginner",
        ...
        "Master the art of strategic thinking with our expert-level online course, "
            ...
            + "to new heights.", "Business and Entrepreneurship Courses");
    Courses mlBasicsPython = new Courses("Machine Learning Basics with Python",
        ...
        "Embark on your journey into the exciting realm of artificial intelligence "
            ...
            + "empowering course.", "Data Science and Analytics Course");
    ...
    Courses databricksFundamentals = new Courses("Databricks Fundamentals", "Beginner",
        ...
        "Embark on your data journey with our beginner-level online course,"
            ...
            + "and empowering course.", "Data Science and Analytics Course");

    coursesRepository.saveAll(List.of(realTimeProgrammingJava, sql, webAppWithDotNet,
        azureFundamentals, azureAdministration, awsCloudPractitioner, seo, socialMediaMarketing,
        businessStrategy, mlBasicsPython, imageRecognition, databricksFundamentals));
